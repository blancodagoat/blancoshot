...
{
    public static readonly HotkeyBinding DefaultRegion = new(Keys.PrintScreen, false, false, false, false);
    public static readonly HotkeyBinding DefaultFullDisplay = new(Keys.F8, false, false, false, false);
